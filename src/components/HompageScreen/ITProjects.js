...
const ITProjects = () => {
  return (
    <div className=" bg-white py-5">
      <h1 className=" w-full text-center text-3xl font-extrabold py-10 bg-black text-white">
        What Is the Next IT Project You Need Help With?
      </h1>
      <div className=" py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-7">
        <div className=" w-[260px] h-[260px] mx-auto group [perspective:1000px] ">
          <div className=" rounded-md shadow-md shadow-black text-center w-[260px] h-[260px] relative [transform-style:preserve-3d] group-hover:[transform:rotateX(180deg)] transition-transform duration-200 rotate-180">
            <div className=" flex justify-center items-center  text-4xl h-[260px] w-[260px] bg-gray-300 absolute  [transform:rotate(180deg)] ">
              <h1>IT Network Project</h1>
            </div>
            <div className=" text-xs px-2 py-6 h-[260px] w-[260px] bg-black text-white absolute [transform:rotateX(180deg)] [backface-visibility:hidden]">
              <p>
        ...
        <div className=" w-[260px] h-[260px] mx-auto group [perspective:1000px]">
          <div className=" rounded-lg shadow-md shadow-black text-center w-[260px] h-[260px] relative [transform-style:preserve-3d] group-hover:[transform:rotateX(180deg)] transition-transform duration-200 rotate-180">
            <div className=" flex justify-center items-center  text-4xl h-[260px] w-[260px] bg-gray-300 absolute  [transform:rotate(180deg)] ">
