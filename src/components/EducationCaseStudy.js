        ...
        <div>
          ...
          <div className=" w-[80%] mx-auto text-gray-500">
            <p>
              ...
              access, bandwidth, and security.”
              <br />
              <br /> For example, Langley can provide more open network access
              for sixth formers (ages 16 and up), with tighter control for
              younger users. Teachers and operational staff have their own
              networks, and Youngs can also provision a network for day visitors
              or guests booking out-of-term accommodations.
              <br />
              <br /> With clear boundaries and policies in place, the school is
              more confident in exploring possibilities. Teachers are encouraged
              to find a work style that suits them and there is no central
              mandate on how lessons should be taught. From April 2022, year
              three students and upwards will be issued devices. With a solid
              network in place, Youngs’ role, he says, is to support staff and
              students and to explore what might be possible.
              <br />
              ...
              the campus is useful.”
              <br />
              <br /> With students boarding (and a high percentage of
              international students), the network can also be used to support
              positive student well-being. Location tracking can pinpoint
              students across each campus and apps can be used to help students
              ...
              reassuring for parents.” <br />
              <br />
              “It’s my hope that our [IT] team can use Meraki products to change
              our jobs from being merely a help desk to helping our faculty use
              all kinds of technology in the classroom,” said Youngs. <br />
              <br />
              “Students are using new technology everywhere else in their lives,
              so why not at Langley, too?” By choosing Meraki, Langley School
              was quickly able to adapt to the changes the pandemic
              <br />
              <br /> brought to their campuses while prioritizing remote
